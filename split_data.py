...
for root, dirs, files in os.walk(images_path, topdown=True):
    for name in files:
        ...
        mask_path = os.path.join(masks_path, name + "_bin.png")
        ...
        if random.random() < TRAIN_PROPORTION:
            ...
            os.popen(f"cp -rvf {label_path} {labels_train_path}")

            # dst_path = os.path.join(masks_train_path, name + "_bin.png")
            ...
            os.popen(f"cp -rvf {label_path} {labels_val_path}")

            # dst_path = os.path.join(masks_val_path, name + "_bin.png")
